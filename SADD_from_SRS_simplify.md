...
| 审计字段 | `operator_user_id`、`operator_username`、`object`、`action`、`result`、`trace_id`、`request_id`、`action_source`、`agent_profile`、`execution_mode`、`confirm_level`、`blocked_reason` |
